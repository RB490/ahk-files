...
Main.Margin(0, 0)
Main.CLV := new LV_Colors(Main.Add("ListView", "h" Settings.Pos.Height - 25 " w" Settings.Pos.Width " gListAction -E0x200 -Grid -TabStop -Hdr +AltSubmit", "Result|TimesRun|score"))
;Main.AltRows()
