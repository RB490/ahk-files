/*
Example: get handle to picture for setting gui icon

ico := new LoadPictureType(APP_ICON,, 1, "#000000") ; last parameter color will be transparent, you might need to change this.
_ico := ico.GetHandle()
